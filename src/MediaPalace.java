...
public class MediaPalace {
	...
	/*
	 * To use this method, the image must be placed in your Eclipse project in
	 ...
	 * http://www.javazoom.net/javalayer/javalayer.html, and add the jar to
	 * project. Then uncomment this method.
	 */
	// private void playMp3FromComputer(String fileName) throws
	// JavaLayerException {
	 ...
	 * http://media.io
	 */
	public AudioClip loadLoadSound(String fileName) {
