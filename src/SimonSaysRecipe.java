...
public class SimonSaysRecipe extends KeyAdapter {
 ...
 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
 		images.put(new Integer(KeyEvent.VK_UP), "Up_(2009_film).jpg");
 		images.put(new Integer(KeyEvent.VK_LEFT), "huracan.png");
 		images.put(new Integer(KeyEvent.VK_RIGHT), "maxresdefault.jpg");
